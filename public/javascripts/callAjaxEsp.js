...
let ajaxcallObj = {
  method: 'GET',
  url: "https://sandbox.musement.com/api/v3/activities?text=&text_operator=AND&extend_other_languages=YES&extend_content_fields=NO&fuzziness_level=LEVEL-0&zero_terms_query=NONE&sort_by=relevance&limit=50&offset=0",
  asynchronous: true,
}
